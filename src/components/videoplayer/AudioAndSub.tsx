export default function AudioAndSubs() {
  return (
    <div className="relative z-40 h-10  w-10 text-white">
      <svg
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="relative top-4 h-10 w-10 cursor-pointer transition-all  hover:scale-125"
        data-name="Subtitles"
        aria-hidden="true"
      >
        <path
